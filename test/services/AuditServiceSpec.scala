...
import models.amend.JsonAuditModel
...
class AuditServiceSpec extends SpecBase with MockitoSugar with BeforeAndAfterEach {
  ...
  override protected def beforeEach(): Unit = {
    ...
    when(mockFrontendConfig.appName).thenReturn("ioss-intermediary-exclusions-frontend")
  }
  ...
  "AuditService" - {
    ...
    "build and send an ExtendedDataEvent with the correct details" in {
      ...
      capturedEvent.auditSource mustBe "ioss-intermediary-exclusions-frontend"
