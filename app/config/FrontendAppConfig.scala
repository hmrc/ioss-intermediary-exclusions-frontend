...
class FrontendAppConfig @Inject() (configuration: Configuration) {
  ...
  private val contactFormServiceIdentifier = "ioss-intermediary-exclusions-frontend"
  ...
  val exitSurveyUrl: String             = s"$exitSurveyBaseUrl/feedback/ioss-intermediary-exclusions-frontend"
